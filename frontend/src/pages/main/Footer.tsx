        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-3 col-md-6 footer-contact">
              ...
              <div>
                <strong style={{ color: '#87CEEB' }}>Contact the Hashira for Help</strong>
                <br />
                <br />
                Need protection from demons? Contact the elite Hashira warriors:
                <br />
                <br />
                <strong style={{ color: '#87CEEB' }}>Flame Hashira (Rengoku):</strong> rengoku@demonslayers.local
                <br />
                <strong style={{ color: '#87CEEB' }}>Water Hashira (Giyu):</strong> giyu@demonslayers.local
                <br />
                <strong style={{ color: '#87CEEB' }}>Insect Hashira (Shinobu):</strong> shinobu@demonslayers.local
                <br />
                <br />
                ...
                <br />
                <strong>General Inquiries:</strong> hashira@demonslayers.local
                <br />
